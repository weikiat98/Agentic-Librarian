...
if __name__ == "__main__":
    ...
    Here we provide background information that helps readers understand the context.
    
    CHAPTER 2: Main Content
    
    This chapter contains the core content of our document.
    
    Section 2.1: Key Concepts
    We introduce key concepts that are fundamental to understanding the material.
    
    Section 2.2: Detailed Analysis
    A detailed analysis of the concepts follows here.
    """
    ...
    chapters = chunker.chunk_by_chapters(sample_doc)
    ...
    # Smart chunking
    print("\n\nSmart chunking:")
    smart_chunks = chunker.smart_chunk(sample_doc)
